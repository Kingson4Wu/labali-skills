...
**Never commit automatically.** Only commit when the user explicitly requests it — e.g., says "commit", or invokes `/labali-git-auto-commit-rewrite`. Completing a task does not imply permission to commit.
