...
4. Pass 1 local re-encode to intermediate mp4.
5. Pass 2 sanitize from intermediate with metadata/chapter removal, bitexact flags, video+audio re-encode, and MP4 container options.
