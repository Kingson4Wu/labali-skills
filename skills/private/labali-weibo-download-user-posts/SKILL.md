...
license: MIT
compatibility: macOS / Linux; requires Chrome with remote-debugging enabled (default port 9223), profile `~/.chrome-labali-no-proxy`, and an authenticated Weibo session; Node.js ≥ 18 + tsx; internet access required.
